...
function Portfolio() {
    ...
    return (
        <div name="portfolio" className='bg-gradient-to-b from-black to-gray-900 w-full pt-24 sm:h-screen h-screen'>
            ...
            <div className='max-w-screen-lg mx-auto p-4 flex flex-col 
               justify-center w-full h-full text-white'>
                <div>
                 ...
                 p-2'>Portfolio</p>
                    <p className='py-6'>Check Out some
                        of my work right here</p>
                </div>
                ...
                py-2 ' >
                        ...
                        <div className='flex items-center justify-center'>
                                <button className='text-white w-1/2  
                                 m-4 duration-200 hover:scale-150'>Demo</button>
                                <button className='text-white w-1/2   m-4 
                             duration-200 hover:scale-150'>Code</button>
                            </div>
            </div>
              ))}
